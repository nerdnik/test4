...
(m-3-2) edge node [left] {c} (m-4-1)
	edge node [right] {u} (m-4-4)
(m-3-4) edge node [left] {c'} (m-4-2)
	edge node [right] {u'} (m-4-5)
(m-3-1) edge node [left] {$b_1$} (m-4-1)
...
(m-5-1) edge node [left] {$b_1$'} (m-6-2) 
(m-5-2) edge node [left] {c} (m-6-4)
(m-5-4) edge node [right] {u'} (m-6-2)
(m-5-5) edge node [right] {$b_2$} (m-6-4)
(m-5-2) edge node [left] {c} (m-6-1)
	edge node [right] {u} (m-6-4)
(m-5-4) edge node [left] {c'} (m-6-2)
...
(m-3-2) edge node [left] {$u$} (m-4-1)
	edge node [right] {$c$} (m-4-4)
(m-3-4) edge node [left] {$u'$} (m-4-2)
